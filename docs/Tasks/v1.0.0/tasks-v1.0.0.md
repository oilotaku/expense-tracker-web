...
| --- | --- | --- | --- | --- | --- | --- |
| 001 | 使用者認證（後端） | in_progress | ✓ | — | `backend/app/models/user.py`、`backend/app/schemas/auth.py`、`backend/app/api/v1/auth.py`、`backend/app/repositories/user_repository.py`、`backend/app/services/auth_service.py`、`backend/alembic/versions/{rev}_add_users.py`、`backend/tests/api/test_auth.py` | sub-agent |
| 002 | 帳戶 Account（後端） | pending | ✓ | task-001 | `backend/app/models/account.py`、`backend/app/schemas/account.py`、`backend/app/api/v1/accounts.py`、`backend/app/repositories/account_repository.py`、`backend/alembic/versions/{rev}_add_accounts.py`、`backend/tests/api/test_accounts.py` | — |
| 003 | 分類 Category（後端，含系統預設種子） | pending | ✓ | task-001 | `backend/app/models/category.py`、`backend/app/schemas/category.py`、`backend/app/api/v1/categories.py`、`backend/app/repositories/category_repository.py`、`backend/alembic/versions/{rev}_add_categories.py`、`backend/tests/api/test_categories.py` | — |
...
| 005 | 認證前端頁面 | pending | ✓ | task-001 | `frontend/src/lib/api/authApi.ts`、`frontend/src/app/login/page.tsx`、`frontend/src/app/register/page.tsx`、`frontend/src/components/AuthGuard.tsx` | — |
