...
| 014 | 報價 client + Redis 快取層 | in_progress |  | task-011, task-012, task-013 | `backend/app/clients/stock_price_client.py`、`backend/app/clients/metal_price_client.py`、`backend/app/core/cache.py`、`backend/app/services/pricing_service.py`、`docker-compose.yml`、`.env`、`backend/pyproject.toml`、`backend/tests/services/test_pricing_service.py` | sub-agent |
